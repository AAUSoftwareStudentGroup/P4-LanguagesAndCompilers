				...
				if(t1 != null && t1.Name == "IntType")
				{
					...
					if(t2 != null && t2.Name == "IntType")
					{
						...
						if(id1 != null && id1.Name == "identifier")
						{
							...
							if(id2 != null && id2.Name == "identifier")
							{
								(Compiler.AST.Data.Node iexpr, Compiler.Translation.SymbolTable.Data.Node symbolTable1) = Translate(identifierDeclaration[3][1][0] as Compiler.Parsing.Data.Expression, symbolTable as Compiler.Translation.SymbolTable.Data.SymbolTable);
				...
				if(t1 != null && t1.Name == "BooleanType")
				{
					...
					if(t2 != null && t2.Name == "BooleanType")
					{
						...
						if(id1 != null && id1.Name == "identifier")
						{
							...
							if(id2 != null && id2.Name == "identifier")
							{
								(Compiler.AST.Data.Node bexpr, Compiler.Translation.SymbolTable.Data.Node symbolTable1) = Translate(identifierDeclaration[3][1][0] as Compiler.Parsing.Data.Expression, symbolTable as Compiler.Translation.SymbolTable.Data.SymbolTable);
				...
				if(t1 != null && t1.Name == "RegisterType")
				{
					...
					if(t2 != null && t2.Name == "RegisterType")
					{
						...
						if(id1 != null && id1.Name == "identifier")
						{
							...
							if(id2 != null && id2.Name == "identifier")
							{
								(Compiler.AST.Data.Node rexpr, Compiler.Translation.SymbolTable.Data.Node symbolTable1) = Translate(registerStatement[1][2][1][0] as Compiler.Parsing.Data.Expression, symbolTable as Compiler.Translation.SymbolTable.Data.SymbolTable);
